...
TEMPLATE_SARCOME: TemplateOrgane = TemplateOrgane(
    ...
    mots_cles_detection=["sarcome", "tissus mous", "parties molles", "sous-cutané", "sous-cutanée", "sous cutane", "lipome", "tumeur adipeuse", "adipeux", "liposarcome", "léiomyosarcome", "rhabdomyosarcome", "synovialosarcome", "fibrosarcome", "histiocytofibrome", "DFSP", "GIST", "tumeur desmoïde", "myxofibrosarcome", "sarcomateux", "fusiforme"],
